 ...
 *
****************************************************************************************************/
kme.bootstrapCarousel = function (options){
 ...
 *
****************************************************************************************************/
kme.owlCarousel = function (options){
...
kme.portfolio = function (selector,options){
 ...
 *
****************************************************************************************************/			
kme.scrollAnim = function(option){	
		$(window).load(function() {
			if(option == "yes"){		
 ...
 *
****************************************************************************************************/
kme.headSlider = function(selector, options){
