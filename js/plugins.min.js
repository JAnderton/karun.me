(function(){function e(){}for(var a,b="assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd table time timeEnd timeStamp trace warn".split(" "),c=b.length,d=window.console=window.console||null;c--;)a=b[c],d[a]||(d[a]=e)})();
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('(2($){$.W.X=2(M){4 8=$.19({K:".c-6",O:"#c",q:".c-3",I:".c-7",h:".c-h",g:".Y-c"},M);4 b=$(f);4 $6=$(8.K);4 $3=$(8.q);4 $7=$(8.I);4 h=$(8.h);4 $g=8.g;4 j=18;2 S(){$6.Q();$3.Q()}4 C=(!!13.Z&&+(/16\\s(\\d+)/i.12(11.10)[1]))||14;a(C<=9){}v{b.17(2(){b.15($(f)).G().n({l:0.5},E)},2(){b.G().n({l:1},E)})}b.A("z H",2(e){e.F();4 3=$(f).D(8.q).u();a($(f).1c("k")){a(j){x()}$(f).t("k")}v{b.t("k");$(f).1q("k");a(j){R(3)}v{r(3)}}});h.A("z H",2(e){e.F();a(j){x()}b.t("k")});2 r(3){$7.1n(3);4 p=$7.D($g);a(p.1m!=0){a($($g).B(\'w\')!=1a){$($g).B(\'w\').1r()}p.w({1p:m,1l:$3,1e:m,1b:m})}$6.J({"-1f-1g-1j":"1i","1h":"1k%"});$7.J("l","0");$6.1d("o",2(){j=m;$7.n({l:1},1o);$.N(\'.c-6\',L,{P:\'U\',T:\'y\'})})}2 x(){$6.V("o",2(){$7.u("");$.N(8.O,L,{P:\'U\',T:\'y\'})})}2 R(3){$6.V("o",2(){$7.u("");r(3)})}S()}}(1s));',62,91,'||function|content|var||wrapper|container|settings||if|_self|portfolio|||this|carousel|close||windowActive|active|opacity|true|animate|slow|_carousel|pContent|showContent||removeClass|html|else|owlCarousel|closeContent||click|bind|data|IE|find|300|preventDefault|stop|touchstart|pContainer|css|pWrapper|800|options|scrollTo|section|easing|hide|closeShowContent|init|axis|easeOutExpo|slideUp|fn|portfolioExpander|owl|ActiveXObject|userAgent|navigator|exec|window|NaN|not|msie|hover|false|extend|null|autoPlay|hasClass|slideDown|lazyLoad|webkit|backface|height|hidden|visibilit|100|responsiveBaseWidth|length|append|400|singleItem|addClass|destroy|jQuery'.split('|'),0,{}));
...
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create','UA-49982514-1','karun.me');ga('send','pageview')